...
void Deletes(Stack*& myStk)
{
    ...
    cout << "Элементы, которые делятся на 3 без остатка, удалены из стека." << endl;
}
...
{
    ofstream fileone("D:/Денис/2 сем/оаип/лабы/files/lab7.11.txt");
    if (!fileone) {
...
void FromFile(Stack*& myStk)
{
    ...
    char buf[50];
    int number;
    ifstream filetwo("D:/Денис/2 сем/оаип/лабы/files/lab7.11.txt");
    if (!filetwo) {
