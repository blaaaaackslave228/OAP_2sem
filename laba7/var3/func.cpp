...
void DeletePositive(Stack*& myStk)
{
    Stack* current = myStk;
    ...
    cout << "Положительные элементы отсутствуют в стеке." << endl;
}
...
{
    ofstream fileone("D:/Денис/2 сем/оаип/лабы/files/lab7.3.txt");
    if (!fileone) {
...
void FromFile(Stack*& myStk)
{
    ...
    char buf[50];
    int number;
    ifstream filetwo("D:/Денис/2 сем/оаип/лабы/files/lab7.3.txt");
    if (!filetwo) {
